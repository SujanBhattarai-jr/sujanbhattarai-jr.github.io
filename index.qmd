  ...
  <div class="areas-of-interest">
    ...
    <div class="colu">
      <div class="colus">
        ...
        <p>Enjoys analytical thinking and integrating AI for data-driven decision making</p>
      </div>
      <div class="colus">
        <h3>Machine Learning</h3>
        <p>Strong understanding of ML algorithms: neural networks, tree based models, classifications & regressions</p>
      </div>
      <div class="colus">
        <h3>Applied Statistics</h3>
        <p>Experienced at First order effects, DID estimate, panel data, inverse weighted regression</p>
      </div>
      <div class="colus">
        <h3>Databases & Big Data</h3>
        <p>Proficient at RDBMS, Certified data analyst with SQL by Datacamp  </p>
      </div>
      <div class="colus">
        <h3>Modelling</h3>
        <p> Skilled at experimental designs with randomize sampling, ARIMA forecasting, quantifying uncertainties</p>
      </div>
      <div class="colus">
        <h3>Geospatial analysis</h3>
        Knowledged at GeoSpatial analysis and data visualization concepts: Expert at raster and vector databases, hyperdimensional data</p>
      </div>
    </div>
  </div>
